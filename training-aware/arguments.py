...
def get_args():
    ...
    parser.add_argument('--lamb', default=0.0, type=float, help='(default=%(default)f)')
    parser.add_argument('--lamb_w', default=0.0, type=float, help='(default=%(default)f)')
    parser.add_argument('--lamb_d', default=0.0, type=float, help='(default=%(default)f)')
